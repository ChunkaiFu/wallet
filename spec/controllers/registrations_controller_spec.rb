...
RSpec.describe RegistrationsController, type: :controller do
    ...
    describe "POST #create" do
      context "with valid parameters" do
        let(:valid_params) { { user: { email: "test@example.com", firstname: "John", lastname: "Doe", password: "password", password_confirmation: "password" } } }
      ...
      context "with invalid parameters" do
        let(:invalid_params) { { user: { email: "invalid_email", firstname: "John", lastname: "Doe", password: "password", password_confirmation: "different_password" } } }
